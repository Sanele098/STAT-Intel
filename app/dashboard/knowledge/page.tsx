...
const initialSources: Source[] = [
  ...
  { id: 'SRC-006', title: 'Stats SA Tariff Policy (SSI.PUB.002.01)', topic: 'Policies and access', publisher: 'Statistics South Africa', published: 'Sep 2018', format: 'PDF', url: 'https://www.statssa.gov.za/tariff_policy/Tariff_Policy.pdf', status: 'Approved', quality: 97, freshness: 'Current reference', note: 'Direct official PDF; cite the relevant page for publication access, copyright, and tariff-policy questions.' },
  { id: 'SRC-007', title: 'Business Register Quality Improvement Survey 2017 questionnaire', topic: 'Business surveys and methodology', publisher: 'Statistics South Africa', published: '2017', format: 'PDF', url: '/references/stats-sa-business-register-quality-survey-2017.pdf', status: 'Approved', quality: 95, freshness: 'Archived reference', note: 'Supplied PDF; cite the relevant page for confidentiality, survey purpose, business details, turnover, and employment questions.' },
]
